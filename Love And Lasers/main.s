...
; draw_crewmate_menu();
;
L006B:	jsr     _draw_crewmate_menu
;
; game_state = STATE_SELECT_CREWMATE;
;
	lda     #$02
L007E:	sta     _game_state
;
; else if (game_state == STATE_ENDING) {
;
	jmp     L00BF
L00B4:	lda     _game_state
	cmp     #$05
	jne     L00B8
;
; if (!ending_shown) {
...
; show_romance_ending();
;
L006E:	jsr     _show_romance_ending
;
; if (typewriter_ended) {
;
	lda     _typewriter_ended
